...
Nn = 8
mlt1 = MLTraining(model=_models.Model_FMT(20, Nn), L=10, dx=0.05, datafolder="/share/train_data/dx005-1e11s-sin", windowed=True, batchsize=256, num_workers=2, traintest_split=0.8, lr_decay=0.995, lr_start=3e-3)
