...
Nn = 12
mlt1 = MLTraining(model=_models.Model_FMT2(20, Nn), L=10, dx=0.05, datafolder="/share/train_data/dx005-mixed-3", windowed=True, batchsize=64, num_workers=2, traintest_split=1, lr_start=3e-4, batch_lr_decay=1-1e-5, min_lr=2e-6)
